...
public class VehicleLoan extends Loan {
    private final double ANNUAL_INTEREST_RATE = 8.0;
    ...
    public String toString() {
        return String.format("%s%n\t%s: $%,.2f%n\t%s: %d years%n\t%s: %%%.2f%n\t%s: $%,.2f%n%n", "VEHICLE LOAN", "Principal Amount", getPrincipalAmount(), "Tenure", getTenure(), "Interest Rate", ANNUAL_INTEREST_RATE, "Monthly Installment", getMonthlyInstallment());
    }
}
